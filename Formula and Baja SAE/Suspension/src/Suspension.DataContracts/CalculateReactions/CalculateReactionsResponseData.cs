...
public class CalculateReactionsResponseData
{
    ...
    /// <summary>
    /// Rounds each value for each <see cref="Force"/> at <see cref="CalculateReactionsResponseData"/> 
    ...
    public CalculateReactionsResponseData Round(int decimals)
    {
        ...
        {
            LowerWishboneReaction1 = LowerWishboneReaction1.Round(decimals),
            LowerWishboneReaction2 = LowerWishboneReaction2.Round(decimals),
            UpperWishboneReaction1 = UpperWishboneReaction1.Round(decimals),
            UpperWishboneReaction2 = UpperWishboneReaction2.Round(decimals),
            ShockAbsorberReaction = ShockAbsorberReaction.Round(decimals),
            TieRodReaction = TieRodReaction.Round(decimals)
        };
    }
}

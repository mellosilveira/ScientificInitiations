...
{
    public static Point3D CreateOrigin() => new() { X = 0, Y = 0.75, Z = 0 };

    public static SuspensionSystem CreateSuspensionSystem() => new()
    {
    ...
    public static CalculateReactionsRequest CreateRequest() => new()
    {
        Origin = "0,0.75,0",
    ...
    public static JToken CreateDisplacementMatrixAsJToken() => JToken.Parse(
    @"[
            [
            0.2536444394535612,
            -0.616054625333608,
    ...
    public static CalculateReactionsResponseData CreateResponseData() => new()
    {
    ...
    public static OperationResponseBase<CalculateReactionsResponseData> CreateResponse()
        => OperationResponse.CreateSuccessOk<OperationResponseBase<CalculateReactionsResponseData>>();
}